...
urlpatterns = [
    ...
    path('update_members_sprint/<int:id_proyecto>/<int:id_sprint>/<int:id_miembro>', views.update_members_sprint, name='update-members_sprint'),
    ...
    path('log_user_story/<int:id_proyecto>/<int:id_user_story>/<int:id_tipo_us>/<int:id_sprint>/<int:dir>', views.log_user_story, name="log-user-story"),
    ...
    path('tablero_kanban/<int:id_proyecto>/<int:id_tipo_us>/<int:id_sprint>', views.tablero_kanban, name='tablero-kanban'),
    path('update_user_story_kanban_avanzar/<int:id_proyecto>/<int:id_user_story>/<int:id_tipo_us>/<int:id_sprint>', views.update_user_story_kanban_avanzar, name='update-user-story-kanban-avanzar'),
