...
urlpatterns = [
    ...
    path('inicializar_sprint/<int:id>', views.inicializar_sprint, name='inicializar_sprint'),
    path('cancelar_sprint/<int:id>', views.cancelar_sprint, name='cancelar_sprint'),
    path('finalizar_sprint/<int:id>', views.finalizar_sprint, name='finalizar_sprint'),
